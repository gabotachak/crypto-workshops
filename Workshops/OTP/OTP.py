...
print(f"Encrypting 'HELLO' with key 'EOXJF': {otp.encrypt_str('HELLO', 'EOXJF')}")
print(f"Decrypting 'LSIUT' with key 'EOXJF': {otp.decrypt_str('LSIUT', 'EOXJF')}")
...
print(f"Encrypting '{t}' with key '{k}': {otp.encrypt_str(t, k)}")
...
print(f"Decrypting '{t}' with key '{k}': {otp.decrypt_str(t, k)}")
